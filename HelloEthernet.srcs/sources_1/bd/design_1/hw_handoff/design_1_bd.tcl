...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set REF_CLK_ETH [ create_bd_port -dir O -type clk REF_CLK_ETH ]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports REF_CLK_ETH] [get_bd_pins clk_wiz_0/clk_out2]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins axi_ethernetlite_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
